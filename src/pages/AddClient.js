            ...
            <div className='bg-white w-[420px] mt-4 mx-[600px] rounded-lg'>
                <form className='w-[400px] bg-white items-center justify-center p-4'>
                    ...
                    <div className='mt-8 '>
                      ...
                      <input className="w-full mx-2 mt-3 h-10 px-3 text-base text-sm placeholder-gray-350 border rounded-lg focus:shadow-outline" 
                      type="text" placeholder="|123456789" id="forms-labelOverInputCode"
                          value={legal} onChange={handleLegal}
                      />
                    </div>
                    ...
                    <div className='relative'>
                        <div className='mt-2 '>
                            ...
                            <input className="w-full mx-2 mt-3 h-10 px-3 text-base text-sm placeholder-gray-350 border rounded-lg focus:shadow-outline" 
                            type={seePassword === false ? 'password' : 'text'} placeholder="|*******" id="forms-labelOverInputCode"
            ...
            <div className='bg-white w-[420px] mt-4 mx-[600px] rounded-lg'>
               <form className='w-[400px] bg-white items-center justify-center p-4'>
                  ...
                  <div className='mt-8 '>
                      ...
                      <input className="w-full mx-2 mt-3 h-10 px-3 text-base text-sm placeholder-gray-350 border rounded-lg focus:shadow-outline" 
                      type="text" placeholder="|John" id="forms-labelOverInputCode" onChange={handleFirstName} value={firstName}/>
                  </div>

                  <div className='mt-2 '>
                      <label className="block mb-1 text-[12px] px-6 absolute mt-1px" for="forms-labelOverInputCode">family name</label>
                      <input className="w-full mx-2 mt-3 h-10 px-3 text-base text-sm placeholder-gray-350 border rounded-lg focus:shadow-outline" 
                      type="text" placeholder="|Doe" id="forms-labelOverInputCode" onChange={handleFamilyName} value={familyName}/>
                  </div>

                  <div className='mt-2 '>
                      <label className="block mb-1 text-[12px] px-6 absolute mt-1px" for="forms-labelOverInputCode">Street/House number</label>
                      <input className="w-full mx-2 mt-3 h-10 px-3 text-base text-sm placeholder-gray-350 border rounded-lg focus:shadow-outline" 
                      type="text" placeholder="|8" id="forms-labelOverInputCode" onChange={handleStreet} value={street}/>
                  </div>

                  <div className='mt-2 '>
                      <label className="block mb-1 text-[12px] px-6 absolute mt-1px" for="forms-labelOverInputCode">City</label>
                      <input className="w-full mx-2 mt-3 h-10 px-3 text-base text-sm placeholder-gray-350 border rounded-lg focus:shadow-outline" 
                      type="text" placeholder="|Berlin" id="forms-labelOverInputCode" onChange={handleCity} value={city}/>
                  </div>

                  <div className='mt-2 '>
                      <label className="block mb-1 text-[12px] px-6 absolute mt-1px" for="forms-labelOverInputCode">Zip code</label>
                      <input className="w-full mx-2 mt-3 h-10 px-3 text-base text-sm placeholder-gray-350 border rounded-lg focus:shadow-outline" 
                      type="text" placeholder="|10997" id="forms-labelOverInputCode" onChange={handleZip} value={zip}/>
                  </div>

                  <div className='mt-2 '>
                      <label className="block mb-1 text-[12px] px-6 absolute mt-1px" for="forms-labelOverInputCode">Start date</label>
                      <input className="w-full mx-2 mt-3 h-10 px-3 text-base text-sm placeholder-gray-350 border rounded-lg focus:shadow-outline" 
                      type="text" placeholder="|10-12-2021" id="forms-labelOverInputCode" onChange={handleStart} value={start}/>
                  </div>

                  <div className='mt-2 '>
                      <label className="block mb-1 text-[12px] px-6 absolute mt-1px" for="forms-labelOverInputCode">Type of job</label>
                      <input className="w-full mx-2 mt-3 h-10 px-3 text-base text-sm placeholder-gray-350 border rounded-lg focus:shadow-outline" 
                      type="text" placeholder="|Pizza seller" id="forms-labelOverInputCode" onChange={handleJob} value={job}/>
                  </div>

                  <div className='mt-2 '>
                      <label className="block mb-1 text-[12px] px-6 absolute mt-1px" for="forms-labelOverInputCode">Type of company</label>
                      <input className="w-full mx-2 mt-3 h-10 px-3 text-base text-sm placeholder-gray-350 border rounded-lg focus:shadow-outline" 
                      type="text" placeholder="|GmbH" id="forms-labelOverInputCode" onChange={handleCompany} value={company}/>
                  </div>

                  <div className='mt-2 '>
                      <label className="block mb-1 text-[12px] px-6 absolute mt-1px" for="forms-labelOverInputCode">Bank name</label>
                      <input className="w-full mx-2 mt-3 h-10 px-3 text-base text-sm placeholder-gray-350 border rounded-lg focus:shadow-outline" 
                      type="text" placeholder="|Targobank" id="forms-labelOverInputCode" onChange={handleBank} value={bank}/>
                  </div>

                  <div className='mt-2 '>
                      <label className="block mb-1 text-[12px] px-6 absolute mt-1px" for="forms-labelOverInputCode">IBAN</label>
                      <input className="w-full mx-2 mt-3 h-10 px-3 text-base text-sm placeholder-gray-350 border rounded-lg focus:shadow-outline" 
                      type="text" placeholder="|*************" id="forms-labelOverInputCode" onChange={handleIBAN} value={iban}/>
                  </div>

                  <div className='mt-2 '>
                      <label className="block mb-1 text-[12px] px-6 absolute mt-1px" for="forms-labelOverInputCode">Status</label>
                      <input className="w-full mx-2 mt-3 h-10 px-3 text-base text-sm placeholder-gray-350 border rounded-lg focus:shadow-outline" 
                      type="text" placeholder="|**********" id="forms-labelOverInputCode" onChange={handleStatus} value={status}
                  ...
                  <div className='mt-2 '>
                      ...
                      <input className="w-full mx-2 mt-3 h-10 px-3 text-base text-sm placeholder-gray-350 border rounded-lg focus:shadow-outline" 
                      type="email" placeholder="|johndoe@gmail.com" id="forms-labelOverInputCode" onChange={handleEmaill} value={emaill}/>
                  </div>

                  <div className='mt-2 '>
                      <label className="block mb-1 text-[12px] px-6 absolute mt-1px" for="forms-labelOverInputCode">Mobile number</label>
                      <input className="w-full mx-2 mt-3 h-10 px-3 text-base text-sm placeholder-gray-350 border rounded-lg focus:shadow-outline" 
                      type="text" placeholder="|+447 123 456 89" id="forms-labelOverInputCode" onChange={handlePhone} value={phone}/>
                  </div>

                  <div className='mt-2 '>
                      <label className="block mb-1 text-[12px] px-6 absolute mt-1px" for="forms-labelOverInputCode">Tax ID(optional)</label>
                      <input className="w-full mx-2 mt-3 h-10 px-3 text-base text-sm placeholder-gray-350 border rounded-lg focus:shadow-outline" 
                      type="text" placeholder="|*******" id="forms-labelOverInputCode" onChange={handleTax} value={tax}/>
                  </div>

                  <div className='mt-2 '>
                      <label className="block mb-1 text-[12px] px-6 absolute mt-1px" for="forms-labelOverInputCode">Notes</label>
                      <input className="w-full mx-2 mt-3 h-10 px-3 text-base text-sm placeholder-gray-350 border rounded-lg focus:shadow-outline" 
                      type="text" placeholder="|Let me know how this goes for you" id="forms-labelOverInputCode" onChange={handleNotes} value={notes}/>
                  </div>
                  <hr className='mt-4 bg-gray-900 border'/>
                    <div className='bg-white'>
                        ...
                        <div className='mt-4'>
                            ...
                            <input className="w-full mx-2 mt-3 h-10 px-3 text-base text-sm placeholder-gray-350 border rounded-lg focus:shadow-outline" 
                            type="text" placeholder="|'Ibrahim Alkais" id="forms-labelOverInputCode" onChange={handleAccountant} value={accountant}/>
                        </div>  
                    </div>
                    <div className="mt-6 flex flex-col items-center font-thin justify-center">
                        <button
